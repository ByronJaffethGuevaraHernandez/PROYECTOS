...
INSERT INTO `categories` (`id`, `name`, `status`, `created_at`, `updated_at`) VALUES
	(34, 'Quimicos 1', 1, '2023-04-16 03:14:24', '2023-04-16 03:14:24');
...
-- Volcando estructura para tabla db_inventory.encargado
CREATE TABLE IF NOT EXISTS `encargado` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `encargado_name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando datos para la tabla db_inventory.encargado: ~16 rows (aproximadamente)
DELETE FROM `encargado`;
INSERT INTO `encargado` (`id`, `encargado_name`, `email`, `phone`, `address`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `icon`, `menu_url`, `status`, `created_at`, `updated_at`) VALUES
	(1, 0, 'Clientes', 'contacts', 'encargado.index', 0, '2020-07-29 13:17:51', '2020-07-29 13:17:56'),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(4, '2018_12_10_052440_create_usuarios_table', 2),
	(5, '2018_12_10_052501_create_encargado_table', 2),
	(6, '2018_12_10_052521_create_stocks_table', 2),
	(7, '2018_12_10_052610_create_orden_table', 2),
	(8, '2018_12_10_052631_create_orden_details_table', 2),
...
INSERT INTO `payments` (`id`, `orden_id`, `encargado_id`, `user_id`, `date`, `paid_in`, `bank_information`, `amount`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `products` (`id`, `category_id`, `product_name`, `details`, `status`, `created_at`, `updated_at`) VALUES
	(30, 34, 'Melasa', 'Mejora El crecimiento', 1, '2023-04-16 03:18:28', '2023-04-16 05:54:34');
...
-- Volcando estructura para tabla db_inventory.Orden
CREATE TABLE IF NOT EXISTS `orden` (
  ...
  `orden_date` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Volcando datos para la tabla db_inventory.orden: ~0 rows (aproximadamente)
DELETE FROM `orden`;
INSERT INTO `orden` (`id`, `user_id`, `encargado_id`, `branch_id`, `total_amount`, `paid_amount`, `orden_date`, `discount_amount`, `payment_method`, `payment_status`, `created_at`, `updated_at`) VALUES
	(51, 12, 40, 1, 412.5, 412.5, '2023-04-17', 0, 2, 1, '2023-04-17 05:33:31', '2023-04-17 05:34:22');

-- Volcando estructura para tabla db_inventory.orden_details
CREATE TABLE IF NOT EXISTS `orden_details` (
  ...
  `ordening_date` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `encargado_id` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `ordening_date` (`ordening_date`),
...
-- Volcando datos para la tabla db_inventory.orden_details: ~0 rows (aproximadamente)
DELETE FROM `orden_details`;
INSERT INTO `orden_details` (`id`, `stock_id`, `orden_id`, `product_id`, `category_id`, `vendor_id`, `user_id`, `chalan_no`, `ordening_date`, `encargado_id`, `sold_quantity`, `buy_price`, `sold_price`, `total_buy_price`, `total_sold_price`, `discount`, `discount_type`, `discount_amount`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `stocks` (
  ...
  `ordening_price` double NOT NULL,
...
DELETE FROM `stocks`;
INSERT INTO `stocks` (`id`, `category_id`, `product_code`, `product_id`, `vendor_id`, `user_id`, `chalan_no`, `buying_price`, `ordening_price`, `discount`, `stock_quantity`, `current_quantity`, `note`, `status`, `created_at`, `updated_at`) VALUES
...
-- Volcando estructura para tabla db_inventory.usuarios
...
-- Volcando datos para la tabla db_inventory.usuarios: ~11 rows (aproximadamente)
DELETE FROM `usuarios`;
INSERT INTO `usuarios` (`id`, `name`, `phone`, `email`, `address`, `created_at`, `updated_at`) VALUES
